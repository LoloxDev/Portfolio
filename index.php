        ...
        <div id="fullpage">
                ...
                <header class="nav" id="nav">
                    ...
                    <nav>
                        <ul id="myMenu">
                            ...
                            <li>
                                <a href="#section4"> Compétences </a>
                            </li>

                            <li>
                                <a href="#section5"> Présentation </a>
                            </li>
                ...
                <section>
                    ...
                    <div class="login-popup">
                        <div class="form-popup" id="popupForm">
                                ...
                                >
                                    <div class="flexform">
                                        <h2>Une idée ? Un projet ? Parlons-en !</h2>
            ...
            <section class="section a3">
                ...
                <ul id="myLife">
                    ...
                    <li>
                        <span> Début de carrière en cuisine </span>
                    </li>
                    ...
                    <li>
                        <span> Découverte du développement WEB </span>
                    </li>

                    <li>
                        <span> Début de formation développeur WEB </span>
                    </li>
            ...
            <section class="section a5">
                ...
                <div id="bitWork">
                    <img src="img/bitmojiWork.png" alt="Un personnage qui étudie"/>
                </div>
                <p>
                ...
                <div id="footer">
                    ...
                    <a href="mentions-legales.html" id="ml">Mentions légales</a>
                </div>
